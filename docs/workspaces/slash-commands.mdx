...
<Tip>
Some commands accept optional arguments. For example, `/compact focus on the authentication changes` requests that the provider emphasise authentication work while compacting. Support for custom compaction instructions is provider-dependent best-effort.
</Tip>
...
| Command | Description |
|---------|-------------|
| `/compact` | Clear conversation history but keep a summary in context. Custom instructions are provider-dependent best-effort |
...
| Command | Description |
|---------|-------------|
| `/compact` | Summarise the conversation to free tokens. Custom instructions are provider-dependent best-effort |
...
| Command | Description |
|---------|-------------|
| `/compact` | Compact the session. Custom instructions are provider-dependent best-effort |
