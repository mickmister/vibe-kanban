...
This project is indexed by GitNexus as **vibe-kanban** (20633 symbols, 44034 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
