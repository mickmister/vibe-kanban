...
This project is indexed by GitNexus as **vibe-kanban** (19824 symbols, 42213 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
