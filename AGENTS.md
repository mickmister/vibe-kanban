...
This project is indexed by GitNexus as **vibe-kanban** (19819 symbols, 42301 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
