...
This project is indexed by GitNexus as **vibe-kanban** (19751 symbols, 42101 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
