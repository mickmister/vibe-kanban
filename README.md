...
| `VK_ALLOWED_ORIGINS` | Runtime | Not set | Comma-separated list of origins that are allowed to make backend API requests; supports exact origins plus hostname wildcard entries like `https://*.example.com` or `https://port-*.example.com:8443` |
