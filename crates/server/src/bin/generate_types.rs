...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::conversation_preview::ConversationPreviewMessageRole::decl(),
        server::routes::conversation_preview::ConversationPreviewMessage::decl(),
        server::routes::conversation_preview::ConversationPreviewSource::decl(),
        server::routes::conversation_preview::ConversationPreview::decl(),
        server::routes::conversation_preview::WarmWorkspaceSessionsRequest::decl(),
        server::routes::conversation_preview::WarmConversationPreviewRequest::decl(),
        server::routes::conversation_preview::WarmConversationPreviewItem::decl(),
        server::routes::conversation_preview::WarmConversationPreviewError::decl(),
        server::routes::conversation_preview::WarmConversationPreviewResponse::decl(),
