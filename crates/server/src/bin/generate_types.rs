...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        services::services::config::AppearanceSettings::decl(),
        services::services::config::ThemePalette::decl(),
        services::services::config::AppFontFamily::decl(),
        services::services::config::MonospaceFontFamily::decl(),
