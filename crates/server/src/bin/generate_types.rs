...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        "export type AgentSandboxConfig = { enabled: boolean, network: SandboxNetworkMode, readonly_paths: Array<SandboxMount>, writable_paths: Array<SandboxMount>, readonly_repo_paths: Array<string>, auth_mounts: Array<SandboxMount>, env_allowlist: Array<string>, sandbox_home?: string | null, };".to_string(),
