...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        "export type HostCommandRequest = { command: string, cwd: string, reason: string, env: Record<string, string>, timeout_secs: number, output_limit_bytes: number, };".to_string(),
        "export type HostCommandResult = { exit_code: number | null, timed_out: boolean, stdout: string, stderr: string, truncated: boolean, };".to_string(),
        ...
        "export type SandboxBackend = \"bwrap\" | \"sandbox_exec\";".to_string(),
        "export type SandboxNetworkMode = \"inherit\" | \"none\";".to_string(),
        "export type SandboxMount = { host_path: string, sandbox_path?: string | null, };".to_string(),
        "export type AgentSandboxConfig = { enabled: boolean, backend: SandboxBackend, network: SandboxNetworkMode, readonly_paths: Array<SandboxMount>, writable_paths: Array<SandboxMount>, readonly_repo_paths: Array<string>, auth_mounts: Array<SandboxMount>, env_allowlist: Array<string>, sandbox_home?: string | null, };".to_string(),
