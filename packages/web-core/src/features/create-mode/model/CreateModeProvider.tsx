...
export function CreateModeProvider({
  ...
  const value = useMemo<CreateModeContextValue>(
    () => ({
      ...
      checkoutBranches: state.checkoutBranches,
      createBranchByRepo: state.createBranchByRepo,
      setCreateBranch: state.setCreateBranch,
      setTargetBranch: state.setTargetBranch,
      setCheckoutBranch: state.setCheckoutBranch,
    ...
    [
      ...
      state.checkoutBranches,
      state.createBranchByRepo,
      state.setCreateBranch,
      state.setTargetBranch,
      state.setCheckoutBranch,
