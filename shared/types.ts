...
export type WebhookConfig = { enabled: boolean, provider: WebhookProvider, webhook_url: string, signing_secret?: string | null, pushover_user_key?: string | null, telegram_chat_id?: string | null, };
