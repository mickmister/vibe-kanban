...
export type PanelTargetFactoryReference = { factoryKey: string, available: boolean, };

export type SessionPanelTargetDefinition = { sessionId: string, workspaceId: string, factory: PanelTargetFactoryReference, };

export type TerminalPanelTargetDefinition = { terminalId: string, workspaceId: string, factory: PanelTargetFactoryReference, };

export type PreviewPanelTargetDefinition = { previewSlotId: string, workspaceId: string, factoryKey: string, available: boolean, };

export type WorkspacePanelTargetAuthoritySnapshot = { ready: boolean, workspaceId: string, workspaceTargets: { [key in string]?: PanelTargetFactoryReference }, sessions: Array<SessionPanelTargetDefinition>, terminalsReady: boolean, terminals: Array<TerminalPanelTargetDefinition>, previews: Array<PreviewPanelTargetDefinition>, };
...
export type RepoWithTargetBranch = { target_branch: string, id: string, path: string, name: string, display_name: string, setup_script: string | null, cleanup_script: string | null, archive_script: string | null, copy_files: string | null, parallel_setup_script: boolean, dev_server_script: string | null, dev_server_scripts: Array<RepoDevServerScript>, default_target_branch: string | null, default_working_dir: string | null, created_at: Date, updated_at: Date, };
